 ...
 * Description - Billiard Room Object
 *
...
public class BilliardRoom extends Room {
    ...
    public BilliardRoom() {
        super("Billiard Room", new Image("/Resources/Images/Room-BilliardRoom.jpg"), new Media (new File("src/Resources/Audio/billiards.mp3").toURI().toString()));
    }
}
